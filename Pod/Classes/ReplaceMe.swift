...
//public func async(queueType: DispatchQueue, block: () -> Void) -> (Void -> Void) {
//    return async(queueType.getQueue(), block: block)
//}
//
//public func async<T>(queueType: DispatchQueue, block: () -> T) -> ((T -> Void) -> Void) {
//    return async(queueType.getQueue(), block: block)
//}
